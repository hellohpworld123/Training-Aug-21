...
SELECT EmployeeID,DBO.EMPID(EmployeeID)AS TOTALSALARY FROM Employees
...
JOIN DAY2.DBO.Locations AS LOC ON DEP.LocationID = LOC.LocationID
WHERE EMP.EmployeeID = @EMPID
);
